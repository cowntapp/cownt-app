import { EditCharacteristicForm } from '@/features/animals/characteristics/components/Forms/EditCharacteristicForm';
...
export const EditCharacteristic = () => {
  ...
  return (
    <div className="flex flex-col gap-y-8 max-w-xl">
      ...
      <EditCharacteristicForm animalType={workspace} />
    </div>
  );
};
